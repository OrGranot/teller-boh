...
export async function GET(
  ...
  const { data: voucher, error } = await supabase
    .from("vouchers")
    .select(
      "voucher_code, amount, buyer_name, recipient_name, recipient_email, personal_message, valid_until, purchased_at"
    )
    .eq("id", id)
...
async function generateVoucherPDF(data: {
  ...
  return new Promise<Buffer>((resolve, reject) => {
    ...
    const bi = 30;
    doc
      .rect(bi, bi, width - bi * 2, height - bi * 2)
      .lineWidth(1)
      .stroke(GOLD);
    doc
      .rect(bi + 8, bi + 8, width - (bi + 8) * 2, height - (bi + 8) * 2)
      .lineWidth(0.5)
      .stroke(SAND);
    ...
    doc
      ...
      .fillColor(GOLD)
      .text(
        "BERLIN  ·  PAPPELALLEE 29  ·  PRENZLAUER BERG",
        0,
        82,
    ...
    // Decorative line
    doc
      .moveTo(width / 2 - 30, 175)
      .lineTo(width / 2 + 30, 175)
      .lineWidth(1)
      .stroke(TERRACOTTA);
    ...
    doc
      .roundedRect(codeBoxX, codeBoxY, codeBoxW, codeBoxH, 4)
      .lineWidth(1.5)
      .stroke(PLUM);
    doc
      .fontSize(18)
    ...
    doc
      ...
      .fillColor(TEXT)
      .font("Helvetica")
      .text("Scan to redeem", qrX, qrY + qrSize + 4, {
        width: qrSize,
        align: "center",
      });
    ...
    if (validUntil) {
      doc
        ...
        .fillColor(TEXT)
        .font("Helvetica")
        .text(`Valid until: ${validUntil}`, 0, footerY, {
          align: "center",
          width,
        });
    }
    doc
      ...
      .fillColor(TEXT)
      .text(
        "Redeemable at Teller Berlin  ·  Pappelallee 29  ·  10437 Berlin",
        0,
        footerY + 18,
        { align: "center", width }
      );
    doc
      .fontSize(8)
      .fillColor(TEXT)
      .text("hello@tellerberlin.com", 0, footerY + 33, {
        align: "center",
        width,
      });
    ...
    doc
      ...
      .fillColor(GOLD)
      .text(
        "SEASONAL  ·  LEVANTINE-INSPIRED  ·  CUISINE",
        0,
        height - 22,
